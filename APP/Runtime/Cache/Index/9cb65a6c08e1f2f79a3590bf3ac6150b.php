...
<form class="form-horizontal center-block" action="<?php echo U(GROUP_NAME . '/Teacher/updateInfo');?>" enctype="multipart/form-data" method="post" name="course" onsubmit="return checkCoords();">
<div class="container-fluid" id="mainContainer">
  <h3 class="text-center">修改用户信息</h3>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control text-center " value="<?php echo ($teacher["name"]); ?>" disabled>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control text-center " value="<?php echo ($teacher["phone"]); ?>" name="phone">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control text-center " value="<?php echo ($teacher["email"]); ?>" name="mail">
            </div>
        </div>
      	 ...
      	 <div class="form-group">
            ...
            <div class="col-sm-4">
                <input id="cy_people" type="text" value="<?php echo ($teacher["qq"]); ?>" class="form-control text-center " name="qq">
            </div>
        </div>
        ...
        <div class="form-group" style="margin-top: 20px;">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" style="height: 200px;" value="<?php echo ($teacher["brief"]); ?>"  name="brief">
            </div>
        </div>
        ...
        <div style="margin-top: 50px; margin-left:35%;">
            <div class=" col-sm-6 ">
                <button class="btn btn-primary form-control" type="submit">确认修改</button>
            </div>
        </div>
  ...
  <div id="hide_container" class="container-fluid">
      <div class="text-right" id="close_btn">关闭</div>
        <div class="row">
             	...
             	<input type="file" id="up_img" class="col-sm-6 control-label" name="imgfile" />
