    ...
    <form class="form-horizontal center-block">
        ...
        <div class="form-group">
            <div class="col-sm-offset-4 col-sm-4 ">
               <a class="btn btn-primary form-control" href="<?php echo U(GROUP_NAME . '/Leader/addExhibition');?>">开设展厅</a>
            </div>
        </div>

        <div class="form-group">
            <div class="col-sm-offset-4 col-sm-4 ">
                  <a class="btn btn-default  form-control" href="<?php echo U(GROUP_NAME . '/Leader/individual');?>">审核展厅作品</a>
            </div>
        </div>
		
		<div class="form-group">
            <div class="col-sm-offset-4 col-sm-4 ">
                  <a class="btn btn-default  form-control" href="<?php echo U(GROUP_NAME . '/Leader/information');?>">修改用户信息</a>
            </div>
        </div>
